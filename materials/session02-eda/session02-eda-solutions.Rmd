...
# Example bar chart from hotels data
ggplot(hotels,
       aes(x = assigned_room_type)) +
  geom_bar()

# Example histogram from hotels data
ggplot(hotels,
       aes(x = adr)) +
  geom_histogram()
...
# Consider each of the four C's and price
...
# add clarity via color or faceting
