...
---
background-image: url(images/session03-rmarkdown/replication-crisis.png
...
* R Markdown gives us just that -- a technological solution for reproducibility.
...
we can think of R Markdown like the advent of the printing press in the 15th century.
...
* R Markdown does something similar for data science today -- you can share your 
R Markdown document with someone else, and that person will have everything they 
...
How does this all come together? Knitting!
...
.center[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/session03-rmarkdown/knit_explained.png")
```
]
...
1. R Markdown sends the .Rmd file to knitr, runs all the code and embeds results and text into an .md file.
...
<video width="1190" height="475" controls>
    <source src="images/session03-rmarkdown/knit_demo.mp4" type="video/mp4"> </video>
...
.center[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/session03-rmarkdown/build-report.png")
```
]
...
What you type in `.Rmd` `r emo::ji("point_down")` 
...
knitr::include_graphics("images/session03-rmarkdown/cheatsheet-markdown.png")
```
...
1. `r emo::ji("file_folder")` Open `your_turn_01.Rmd`.

1. `r emo::ji("mag")` Inspect the contents of <a href="https://rsacdn.link/milestones/conf2022/session03-rmarkdown/data/your_turn_01_solution.html" rel="noopener noreferrer" target="_blank">this HTML output</a>.

1. `r emo::ji("computer")` Add **markdown formatting** to `your_turn_01.Rmd` to re-create the HTML output.

1. `r emo::ji("yarn")` Knit `your_turn_01.Rmd` to check your work.
...
```{r echo=FALSE, out.width="55%"}
knitr::include_graphics("images/session03-rmarkdown/chunk-labels-nav.png")
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/session03-rmarkdown/cheatsheet-knitr.png")
```
...
1. `r emo::ji("file_folder")` Open `your_turn_02.Rmd`.

1. `r emo::ji("mag")` Inspect the contents of <a href="https://rsacdn.link/milestones/conf2022/session03-rmarkdown/data/your_turn_02_solution.html" rel="noopener noreferrer" target="_blank">this HTML output</a>.

1. `r emo::ji("computer")` Add **chunk options** to `your_turn_02.Rmd` to re-create the HTML output.

1. `r emo::ji("yarn")` Knit `your_turn_02.Rmd` to check your work.
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/session03-rmarkdown/cheatsheet-yaml.png")
```
...
1. `r emo::ji("file_folder")` Open `your_turn_03.Rmd`.

1. `r emo::ji("mag")` Inspect the contents of <a href="https://rsacdn.link/milestones/conf2022/session03-rmarkdown/data/your_turn_03_solution.html" rel="noopener noreferrer" target="_blank">this HTML output</a>.

1. `r emo::ji("computer")` Add **YAML metadata** to `your_turn_03.Rmd` to re-create the HTML output.

1. `r emo::ji("yarn")` Knit `your_turn_03.Rmd` to check your work.
...
`r emo::ji("white_check_mark")` **Preview your work:** `r emo::ji("yarn")` early, `r emo::ji("yarn")` often
...
**Create an R Markdown report that summarizes your analysis of the `wine_ratings` dataset.** 

1. Create a new R Markdown file. Give it a title and save it as `wines_report.Rmd`.
...
_File > New File > R Markdown_

```{r echo=FALSE, out.width="50%"}
knitr::include_graphics("images/session03-rmarkdown/open.gif")
```
...
* If you have already started a separate R Markdown file for exploring the 
