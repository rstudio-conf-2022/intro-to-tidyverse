...
`r emo::ji("writing_hand")` ["A unified authoring framework for data science"](https://r4ds.had.co.nz/r-markdown.html?q=yaml%20#r-markdown)
...
.panel[.panel-name[include = FALSE]
...
* Place between curly braces<br>`{r peek}`

* Add options after comma <br>`{r peek, echo=FALSE}`
...
Add a floating table of contents. `r emo::ji("warning")` Indentation matters! `r emo::ji("warning")`
