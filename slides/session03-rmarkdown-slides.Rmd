...
`r emo::ji("heavy_check_mark")` **Style your text:** use markdown for **bold**, *italics*, `code`, `r fontawesome::fa("list")` bullets and `r fontawesome::fa("list-ol")` lists

--

`r emo::ji("heavy_check_mark")` **Style your output:** use chunk options (`echo`, `eval`, etc.)
...
`r emo::ji("heavy_check_mark")` **Organize your code:** use chunk labels
