...
**TODO: Add screenshot of academyMilestones directory**
...
Add a new variable to `patients_2` called `followup` that displays the recommended number of months until follow up for each patient, including the appropriate missing value.
