...
So now, with those procedural things out of the way, let me officially welcome you to the conf component of the Introduction to the [NEXT] Tidyverse! 

This is the first time that we're including an in-person piece within an RStudio Academy course, and we're so excited that we get to pilot this with each one of you. 
...
At Academy, we believe that learning any new skill (whether its musical, computational, athletic -- *any new skill*) is not simply about memorizing new facts...
...
-- apply them to goals both professional and personal.
...
So, by immersing yourself in the content and collaboration the next two days, you're really making a *long-term investment* in yourself. 
...
For the next two days, our goals are to support you in this by allowing for more group work, exposure to new projects and datasets, and increased access to mentors and instructors. Specifically...[CLICK]

1. Drill old wrangling skills and explore new ones [CLICK]

1. Learn best practices for exploring your data and reporting it reproducibly -- both in the Academy platform, but also in your local RStudio IDE.
...
So you already know me, my name is Desiree, I'm a data science educator at RStudio.
...
But you may not have yet met the rest of the team of people behind the work and content that you'll be seeing today & tomorrow. 

You'll be hearing from some as speakers; some of them are your mentors; and of course..

there are some who are not at the the workshop, but whose fingerprints are all over the lessons and tech that are making your Academy experience possible.
...
Alright, so with that, here is what we have...
...
???
this is what our schedule will be like each day [CLICK]

And this is where we'll work...

You'll notice that each session for the next two days has its own workspace in conf2022.rstudioacademy.com


Which leads me to the next agenda item ... [CLICK]
--
...
...on the tech and tooling we'll be using at this workshop
