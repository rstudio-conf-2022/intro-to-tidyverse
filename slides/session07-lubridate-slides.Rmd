...
In this form, we cannot take advantage of the many time-related tools that exist for dates and datetimes. 
---
...
So here our data was in the order Year-Month-Day-Hour-Minute-Second, so we used the YMD_HMS function to turn the column of values into datetimes. 
---
...
???
And we can confirm that the day ofthe week is Monday as we expected.
---
