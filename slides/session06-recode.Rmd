...
Let's begin with some review. Open the R Markdown (milestone?) file for today's session. Run the setup chunk, then use the `review-1` chunk to complete this review.
