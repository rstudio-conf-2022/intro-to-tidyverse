...
readxl::read_excel("data/NationalOutbreakPublicDataTool.xlsx", sheet = 1) %>%
  janitor::clean_names() %>%
  readr::write_csv("data/outbreaks.csv")
```
...
```{r read-in-outbreaks}
outbreaks <- readr::read_csv("data/outbreaks.csv")
```
